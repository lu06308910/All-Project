...
function Parchase() {
        ...
        useEffect(() => {
                ...
                if (mId) {
                        ...
                        axios.get(`http://localhost:9989/member/info/${mId}`)
        ...
        const handleSubmit = () => {
                ...
                // 여러 개 한 번에 POST
                axios.post('http://localhost:9989/delivery/add/all', payloads)
                        .then(res => {
                                ...
                                return axios.post('http://localhost:9989/buy/add', {
                        ...
                        .then(() => {
                                // ✅ buy 저장 성공 후 장바구니 삭제
                                const cartIds = cartList.map(item => item.cartId);
                                return axios.delete('http://localhost:9989/cart/delete', {
        ...
        return (
                <>
                        <div className="footer-container" style={{ backgroundColor: 'white' }}>
                                ...
                                <hr />
                                <div style={{
                                        marginLeft: '30px', marginBottom: '80px', marginTop: '80px', textAlign: 'center', fontWeight: '600',
                                                        ...
                                                        <div style={{ marginTop: '20px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                                                                ...
                                                                {isDirectInput && (
                                                                        <input type='text' placeholder='배송요청사항을 입력해 주세요.'
                                                                                ...
                                                                                style={{
                                                                                        width: '50%', padding: '3px', borderRadius: '5px',
