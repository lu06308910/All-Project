...
const memberEdit = () => {
        ...
        useEffect(() => {
                ...
                const fetchUserData = async () => {
                        try {
                                const response = await axios.get(`http://192.168.4.51:9989/member/edit?userid=${logId}&usertype=${usertype}`);
                                if (response.data) {
                                        setFormData(prev => ({
                                                ...prev,
                                                ...response.data,
        ...
        const handleUpdate = async (e) => {
                ...
                try {
                        const url = formData.usertype === 'PERSONAL'
                                ? 'http://192.168.4.51:9989/member/edit'
                                : 'http://192.168.4.51:9989/member/businessedit';
                        const submitData = {
                                ...formData,
