...
//#region node_modules/tui-color-picker/dist/tui-color-picker.js
var require_tui_color_picker = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/*!
	...
	*/
	(function webpackUniversalModuleDefinition(root, factory) {
		...
		else root["tui"] = root["tui"] || {}, root["tui"]["colorPicker"] = factory();
	})(window, function() {
		return (function(modules) {
			var installedModules = {};
			function __webpack_require__(moduleId) {
				if (installedModules[moduleId]) return installedModules[moduleId].exports;
				var module$4 = installedModules[moduleId] = {
					i: moduleId,
					l: false,
					exports: {}
				};
				modules[moduleId].call(module$4.exports, module$4, module$4.exports, __webpack_require__);
				module$4.l = true;
				return module$4.exports;
			}
			__webpack_require__.m = modules;
			__webpack_require__.c = installedModules;
			__webpack_require__.d = function(exports$2, name, getter) {
				if (!__webpack_require__.o(exports$2, name)) Object.defineProperty(exports$2, name, {
					enumerable: true,
					get: getter
				});
			};
			__webpack_require__.r = function(exports$3) {
				if (typeof Symbol !== "undefined" && Symbol.toStringTag) Object.defineProperty(exports$3, Symbol.toStringTag, { value: "Module" });
			...
			__webpack_require__.n = function(module$5) {
				var getter = module$5 && module$5.__esModule ? function getDefault() {
					return module$5["default"];
			...
			(function(module$6, exports$4, __webpack_require__) {
				"use strict";
				/**
					...
					*/
					filter: function(arr, iteratee, context) {
						...
						forEachArray(arr, function(elem) {
							if (iteratee.apply(context || null, arguments)) result.push(elem);
						});
						return result;
					},
					/**
			...
			(function(module$12, exports$10, __webpack_require__) {
				...
				*/
				...
				module$12.exports = forEachArray;
			}),
			(function(module$13, exports$11, __webpack_require__) {
				...
				*/
				...
				module$13.exports = forEachOwnProperties;
			}),
			(function(module$14, exports$12, __webpack_require__) {
				...
				*/
				function View(options, container) {
					...
					options = options || {};
					if (isUndefined(container)) container = domUtil.appendHTMLElement("div");
				...
				*/
				View.prototype.resize = function() {
					...
					while (parent) {
						if (isFunction(parent._onResize)) parent._onResize.apply(parent, args);
...
appendHTMLElement: function(tagName, container, className) {
			...
			(function(module$16, exports$14, __webpack_require__) {
				...
				*/
				...
				module$16.exports = CustomEvents;
			}),
				...
				var colorUtil = {
					...
					*/
					hexToRGB: function(hexStr) {
						var r, g, b;
						if (!colorUtil.isValidRGB(hexStr)) return false;
					...
					*/
					rgbToHEX: function(r, g, b) {
						...
						if (colorUtil.isValidRGB(hexStr)) return hexStr;
						return false;
					},
					/**
			...
			(function(module$21, exports$19, __webpack_require__) {
				...
				*/
				...
				module$21.exports = preventDefault;
			}),
			(function(module$22, exports$20, __webpack_require__) {
				...
				*/
				...
				module$22.exports = convertToKebabCase;
			}),
 ...
 /**
				...
				*/
				Collection.and = function(filters) {
					...
					return function(item) {
						var i = 0;
						for (; i < cnt; i += 1) if (!filters[i].call(null, item)) return false;
						return true;
					};
				};
				/**
				...
				*/
				Collection.or = function(filters) {
					...
					return function(item) {
						...
						for (; i < cnt; i += 1) result = result || filters[i].call(null, item);
						return result;
					};
				};
				/**
				...
				*/
				Collection.prototype.remove = function(id) {
					...
					ownItems = this.items;
					if (isObject(id)) id = this.getItemID(id);
				...
				*/
				Collection.prototype.has = function(id) {
					...
					has = false;
					if (isFilter) this.each(function(item) {
						if (id(item) === true) {
							has = true;
							return false;
						}
				...
				*/
				Collection.prototype.find = function(filter) {
					...
					this.each(function(item) {
						if (filter(item) === true) result.add(item);
					});
					return result;
				};
				/**
				...
				*/
				Collection.prototype.groupBy = function(key, groupFunc) {
					...
					if (isArray(key)) {
						...
						if (!groupFunc) return result;
						key = groupFunc;
						keyIsFunc = true;
					}
					this.each(function(item) {
						if (keyIsFunc) baseValue = key(item);
						else {
							baseValue = item[key];
							if (isFunction(baseValue)) baseValue = baseValue.apply(item);
						}
						collection = result[baseValue];
						if (!collection) collection = result[baseValue] = new Collection(getItemIDFn);
						collection.add(item);
					});
					return result;
				};
				...
				*/
				Collection.prototype.sort = function(compareFunction) {
					...
					if (isFunction(compareFunction)) arr = arr.sort(compareFunction);
					return arr;
				};
				/**
			...
			(function(module$28, exports$26, __webpack_require__) {
				...
				*/
				...
				if (typeof window !== "undefined" && window.navigator) detectBrowser();
				/**
				* Detect the browser.
				* @private
				*/
					...
					var detector = {
						...
						Netscape: function() {
							...
							if (rIE11.exec(userAgent)) {
								...
								detected = true;
							} else for (key in versionRegex) if (versionRegex.hasOwnProperty(key)) {
							...
							if (!detected) browser.others = true;
						}
					};
					if (detector[appName]) detector[appName]();
				}
				module$28.exports = browser;
			}),
				...
				(function(global) {
					...
					*/
					function Drag(options, container) {
						...
						this.options = extend({ distance: 10 }, options);
						/**
						* @type {HTMLElement}
						*/
						this.container = container;
					...
					*/
					Drag.prototype._onMouseDown = function(mouseDownEvent) {
						if (getMouseButton(mouseDownEvent) !== 0) return;
						this._distance = 0;
						this._dragStartFired = false;
					...
					*/
					...
					module$30.exports = Drag;
				}).call(this, __webpack_require__(25));
			}),
			(function(module$31, exports$29) {
				var g = (function() {
					return this;
				})();
				try {
			...
			(function(module$33, exports$31, __webpack_require__) {
				...
				*/
				function testCSSProp(props) {
					...
					var i, len;
					for (i = 0, len = props.length; i < len; i += 1) if (props[i] in style) return props[i];
					return false;
				}
				module$33.exports = testCSSProp;
			}),
 ...
 /**
				...
				*/
				Palette.prototype._toggleEvent = function(toBind) {
					...
					if (hexTextBox) handleEvent(hexTextBox, "change", this._onChange, this);
				};
				/**
				* Render palette
				* @override
			...
			(function(module$37, exports$35, __webpack_require__) {
				...
				*/
				function Slider(options, container) {
					...
					* @type {Drag}
					*/
					this.drag = new Drag({ distance: 0 }, container);
				...
				*/
				Slider.prototype.render = function(colorStr) {
					...
					var rgb, hsv;
					if (!colorUtil.isValidRGB(colorStr)) return;
				...
				Slider.prototype._setColorSliderPosMax = function() {
					...
					if (sliderRects) this.colorSliderPosLimitRange[1] = sliderRects.height - 10;
				};
				/**
				...
				*/
				Slider.prototype._moveColorSliderHandle = function(newLeft, newTop, silent) {
					...
					if (!silent) this.fire("_selectColor", { color: colorUtil.rgbToHEX.apply(null, this.getRGB()) });
				};
				/**
				...
				*/
				Slider.prototype.getSaturationAndValue = function() {
					...
					return [(position[1] + absMin) / maxValue * 100, 100 - (position[0] + absMin) / maxValue * 100];
				};
				Slider.prototype._setHueBarPosMax = function() {
					var huebarRects = this.huebarSvgElement.getClientRects()[0];
					if (huebarRects) this.huebarPosLimitRange[1] = huebarRects.height - 7;
				};
				/**
				...
				*/
				Slider.prototype.moveHue = function(degree, silent) {
					var newTop = 0;
					var absMin = Math.abs(this.huebarPosLimitRange[0]), maxValue = absMin + this.huebarPosLimitRange[1];
					degree = degree || 0;
				...
				*/
				Slider.prototype._onClick = function(clickEvent) {
					...
					if (cache.isColorSlider) this._moveColorSliderByPosition(mousePos[0], mousePos[1]);
					else this._moveHueByPosition(mousePos[1]);
				...
				module$38.exports = {
					...
					*/
					setTranslateXY: function(obj, x, y) {
						if (isOldBrowser) {
							obj.style.left = x + "px";
							obj.style.top = y + "px";
						} else obj.setAttribute("transform", "translate(" + x + "," + y + ")");
					},
					/**
					...
					*/
					setTranslateY: function(obj, y) {
						if (isOldBrowser) obj.style.top = y + "px";
						else obj.setAttribute("transform", "translate(" + SVG_HUE_HANDLE_RIGHT_POS + "," + y + ")");
					},
					/**
					...
					*/
					setStrokeColor: function(obj, colorStr) {
						if (isOldBrowser) obj.strokecolor = colorStr;
						else obj.setAttribute("stroke", colorStr);
					},
					/**
					...
					*/
					setGradientColorStop: function(obj, colorStr) {
						if (isOldBrowser) obj.color = colorStr;
						else obj.setAttribute("stop-color", colorStr);
					}
				};
			}),
			(function(module$39, exports$37, __webpack_require__) {
				__webpack_require__(34);
				module$39.exports = __webpack_require__(35);
			}),
			...
			(function(module$41, exports$39, __webpack_require__) {
				...
				module$41.exports = {
					...
					Drag: __webpack_require__(24),
					create: __webpack_require__(48),
					Palette: __webpack_require__(29),
					Slider: __webpack_require__(31),
					colorutil: __webpack_require__(12),
					svgvml: __webpack_require__(32)
				};
			}),
			...
			(function(module$43, exports$41, __webpack_require__) {
				...
				*/
				...
				module$43.exports = sendHostname;
			}),
			...
			(function(module$46, exports$44, __webpack_require__) {
				...
				*/
				...
				module$46.exports = setClassName;
			}),
			(function(module$47, exports$45, __webpack_require__) {
				...
				*/
				...
				module$47.exports = isNumber;
			}),
			(function(module$48, exports$46, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				function disableTextSelection(el) {
					if (!el) el = document;
					if (SUPPORT_SELECTSTART) on(el, "selectstart", preventDefault);
					else {
				...
				module$48.exports = disableTextSelection;
			}),
			(function(module$49, exports$47, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$49.exports = setData;
			}),
			(function(module$50, exports$48, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				function enableTextSelection(el) {
					if (!el) el = document;
					if (SUPPORT_SELECTSTART) off(el, "selectstart", preventDefault);
					else {
						el = el === document ? document.documentElement : el;
				...
				module$50.exports = enableTextSelection;
			}),
			(function(module$51, exports$49, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$51.exports = getData;
			}),
			(function(module$52, exports$50, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$52.exports = removeData;
			}),
			(function(module$53, exports$51, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				function getMouseButton(mouseEvent) {
					if (browser.msie && browser.version <= 8) return getMouseButtonIE8AndEarlier(mouseEvent);
				...
				*/
				function getMouseButtonIE8AndEarlier(mouseEvent) {
					...
					if (inArray(button, primaryButton) > -1) return 0;
					if (inArray(button, secondaryButton) > -1) return 2;
					if (inArray(button, wheelButton) > -1) return 1;
					return null;
				}
				module$53.exports = getMouseButton;
			}),
			(function(module$54, exports$52, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				function ColorPicker(options) {
					...
					*/
					...
					if (!options.container) throw new Error("ColorPicker(): need container option.");
					/**********
					* Create layout view
					**********/
					/**
				...
				*/
				ColorPicker.prototype.setColor = function(hexStr) {
					if (!colorUtil.isValidRGB(hexStr)) throw new Error("ColorPicker#setColor(): need valid hex string color value");
				...
				*/
				...
				module$54.exports = ColorPicker;
			}),
			(function(module$55, exports$53, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				function Layout(options, container) {
					...
					* @type {object}
					*/
					this.options = extend({ cssPrefix: "tui-colorpicker-" }, options);
				...
				*/
				...
				module$55.exports = Layout;
			}),
			(function(module$56, exports$54, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$56.exports = createObject;
			}),
			(function(module$57, exports$55, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Palette view template
				*/
				var template = __webpack_require__(52);
				module$57.exports = function(context) {
					return template([
			...
			(function(module$58, exports$56, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$58.exports = template;
			}),
			(function(module$59, exports$57, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				function getMousePosition(position, relativeElement) {
					...
					var rect;
					if (!relativeElement) return [clientX, clientY];
					rect = relativeElement.getBoundingClientRect();
					return [clientX - rect.left - relativeElement.clientLeft, clientY - rect.top - relativeElement.clientTop];
				}
				module$59.exports = getMousePosition;
			}),
			(function(module$60, exports$58, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$60.exports = closest;
			}),
			(function(module$61, exports$59, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$61.exports = matches;
			}),
			(function(module$62, exports$60, __webpack_require__) {
				"use strict";
				/**
				* @fileoverview Transform the Array-like object to Array.
				* @author NHN FE Development Lab <dl_javascript@nhn.com>
				...
				*/
				...
				module$62.exports = toArray;
			}),
			(function(module$63, exports$61, __webpack_require__) {
				"use strict";
				(function(global) {
					var isOldBrowser = __webpack_require__(4).isOldBrowser;
...
//#endregion
//#region node_modules/@toast-ui/editor-plugin-color-syntax/dist/toastui-editor-plugin-color-syntax.js
var require_toastui_editor_plugin_color_syntax = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/*!
	...
	*/
	(function webpackUniversalModuleDefinition(root, factory) {
		if (typeof exports === "object" && typeof module === "object") module.exports = factory(require_tui_color_picker());
		else if (typeof define === "function" && define.amd) define(["tui-color-picker"], factory);
		else if (typeof exports === "object") exports["toastui"] = factory(require_tui_color_picker());
		else root["toastui"] = root["toastui"] || {}, root["toastui"]["Editor"] = root["toastui"]["Editor"] || {}, root["toastui"]["Editor"]["plugin"] = root["toastui"]["Editor"]["plugin"] || {}, root["toastui"]["Editor"]["plugin"]["uml"] = factory(root["tui"]["colorPicker"]);
	})(self, function(__WEBPACK_EXTERNAL_MODULE__858__) {
		return (function() {
			"use strict";
			var __webpack_modules__ = { 858: (function(module$1) {
				module$1.exports = __WEBPACK_EXTERNAL_MODULE__858__;
			}) };
			...
			(function() {
				__webpack_require__.n = function(module$3) {
					var getter = module$3 && module$3.__esModule ? function() {
						return module$3["default"];
					} : function() {
						return module$3;
					};
					__webpack_require__.d(getter, { a: getter });
			...
			(function() {
				...
				function addLangs(i18n) {
					i18n.setLanguage("ar", { "Text color": "لون النص" });
					i18n.setLanguage(["cs", "cs-CZ"], { "Text color": "Barva textu" });
					i18n.setLanguage(["de", "de-DE"], { "Text color": "Textfarbe" });
					i18n.setLanguage(["en", "en-US"], { "Text color": "Text color" });
					i18n.setLanguage(["es", "es-ES"], { "Text color": "Color del texto" });
					i18n.setLanguage(["fi", "fi-FI"], { "Text color": "Tekstin väri" });
					i18n.setLanguage(["fr", "fr-FR"], { "Text color": "Couleur du texte" });
					i18n.setLanguage(["gl", "gl-ES"], { "Text color": "Cor do texto" });
					i18n.setLanguage(["hr", "hr-HR"], { "Text color": "Boja teksta" });
					i18n.setLanguage(["it", "it-IT"], { "Text color": "Colore del testo" });
					i18n.setLanguage(["ja", "ja-JP"], { "Text color": "文字色相" });
					i18n.setLanguage(["ko", "ko-KR"], { "Text color": "글자 색상" });
					i18n.setLanguage(["nb", "nb-NO"], { "Text color": "Tekstfarge" });
					i18n.setLanguage(["nl", "nl-NL"], { "Text color": "Tekstkleur" });
					i18n.setLanguage(["pl", "pl-PL"], { "Text color": "Kolor tekstu" });
					i18n.setLanguage(["pt", "pt-BR"], { "Text color": "Cor do texto" });
					i18n.setLanguage(["ru", "ru-RU"], { "Text color": "Цвет текста" });
					i18n.setLanguage(["sv", "sv-SE"], { "Text color": "Textfärg" });
					i18n.setLanguage(["tr", "tr-TR"], { "Text color": "Metin rengi" });
					i18n.setLanguage(["uk", "uk-UA"], { "Text color": "Колір тексту" });
					i18n.setLanguage("zh-CN", { "Text color": "文字颜色" });
					i18n.setLanguage("zh-TW", { "Text color": "文字顏色" });
				}
				...
				function findParentByClassName(el, className) {
					var currentEl = el;
					while (currentEl && !hasClass(currentEl, className)) currentEl = currentEl.parentElement;
					return currentEl;
				}
				...
				function getCurrentEditorEl(colorPickerEl, containerClassName) {
					return findParentByClassName(colorPickerEl, PREFIX + "defaultUI").querySelector("." + containerClassName + " .ProseMirror");
				}
				...
				*/
				function colorSyntaxPlugin(context, options) {
					...
					addLangs(i18n);
					if (preset) colorPickerOption.preset = preset;
					...
					return {
						markdownCommands: { color: function(_a, _b, dispatch) {
						...
						wysiwygCommands: { color: function(_a, _b, dispatch) {
							var selectedColor = _a.selectedColor;
							var tr = _b.tr, selection = _b.selection, schema = _b.schema;
							if (selectedColor) {
						...
						toolbarItems: [{
							groupIndex: 0,
							itemIndex: 3,
							item: createToolbarItemOption(container, i18n)
						}],
						toHTMLRenderers: { htmlInline: { span: function(node, _a) {
							return _a.entering ? {
								type: "openTag",
								tagName: "span",
